...
const plans = [
  {
    ...
    features: ['1 organisation', 'Jusqu\'à 10 stagiaires', '3 sessions actives', 'Briefs générés par IA', 'Validation de livrables'],
  ...
  },
  {
    ...
    features: ['Organisations illimitées', 'Stagiaires illimités', 'Sessions illimitées', 'Briefs IA avancés', 'Tableau de bord analytics', 'Support prioritaire'],
  ...
  },
  {
    ...
    features: ['Tout le plan Pro', 'SSO / SAML', 'API dédiée', 'Intégration LMS', 'SLA garantie', 'Compte dédié'],
    cta: 'Nous contacter',
    href: '#cta',
    featured: false,
  },
